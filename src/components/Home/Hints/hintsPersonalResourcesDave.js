            ...
            <IconButton edge="end" aria-label="close" onClick={handleClose} className={classes.closeButton}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  "Due to my friends, I tend to be naturally optimistic. And school has really sparked my curiosity. Therefore, I've added <strong>optimism</strong> and <strong>curiosity</strong> to my personal resources."
            </Typography>
              </CardContent>
          </div>
        </Fade>
