            ...
            <IconButton edge="end" aria-label="close" onClick={handleClose} className={classes.closeButton}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  "I have a lot of great colleauges who keep me motivated. Our organization also provides us with the greatest tools. Therefore, I have added <strong>motivating atmosphere</strong> and <strong>good tools</strong> to my job resources"
            </Typography>
              </CardContent>
          </div>
        </Fade>
