            ...
            <IconButton edge="end" aria-label="close" onClick={handleClose} className={classes.closeButton}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  "As psychologist, I've dealt with emotionally unstable people. But I also have to do my own paperwork. Therefore, I've added <strong>emotional strain</strong> and <strong>administration</strong> to my job demands."
            </Typography>
              </CardContent>
          </div>
        </Fade>
