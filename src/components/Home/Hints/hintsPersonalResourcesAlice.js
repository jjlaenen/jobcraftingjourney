            ...
            <IconButton edge="end" aria-label="close" onClick={handleClose} className={classes.closeButton}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  "Running my business has increased my confidence significantly. Additionally, because of my home, I noticed that I focus really easily in general. Therefore, I've added <strong>confidence</strong> and <strong>focus</strong> to my personal resources"
            </Typography>
              </CardContent>
          </div>
        </Fade>
