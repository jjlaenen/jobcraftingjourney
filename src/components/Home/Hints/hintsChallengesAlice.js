...
export default function HintsChallenges() {
            ...
            <IconButton edge="end" aria-label="close" onClick={handleClose} className={classes.closeButton}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  "I noticed that the accounting drains all my energy. Therefore, I want to hire an accountant to reduce the administration job demand."
            </Typography>
              </CardContent>
          </div>
        </Fade>
